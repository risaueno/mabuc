    ...
    def run_simulation(self, n, T, I_samples, data_lists=None):
        ...
        for t in range(T):
            ...
            if action == bestAction:
                ...
                Prob[t] = 0
                best_action_count[t] = best_action_count[t - 1]
                print("NOT BEST ACTION \n")

            Cumulative_Prob = best_action_count / np.arange(1, T + 1)

        return Intent, Action, Reward, Prob, Cumulative_Prob, Conds
